                    ...
                    <div class="card-body">
                        <form id="form_create" action="{{ route('equipamentos.store') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $equip->nome }}" minlength="4" maxlength="50" class="form-control" name="nome" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="select_categoria" class="form-select" id="select_categoria"
                                    ...
                                    <option selected> {{ $equip->categoria }}</option>
                            ...
                            <div class=" col-md-12 mb-3">
                                ...
                                <textarea name="descricao" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $quip->descricao }}</textarea>
                              </div>
                            <div class="col-12">
